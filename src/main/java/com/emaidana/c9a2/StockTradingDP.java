...
public class StockTradingDP {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Ingrese los precios de la acción " + symbol + " para cada día:");
        for (int i = 0; i < N; i++) {
            prices[i] = scanner.nextInt();
        }

        int resultado = maxProfit(K, prices);
        System.out.println("Máxima ganancia posible para la acción " + symbol + ": " + resultado);
        scanner.close();
    }
}